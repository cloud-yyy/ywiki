// Package version provides build-time version information for the ywiki binary.
...
// Example: go build -ldflags="-X github.com/cloud-yyy/ywiki/internal/version.Version=1.0.0".
var (
	Version = "dev"
	Commit  = "none"
	Date    = "unknown"
